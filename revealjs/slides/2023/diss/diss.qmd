...
<div class="r-stack">
  ...
  <p class="fragment fade-in-then-out r-fit-text" data-fragment-index="1" style="border:10px solid #00C1D4; background-color: white; padding:0.4em;">We are interested in how <b>actors</b> are influenced by and interact with their social and cultural environments to bring about <b>novelty</b>, e.g. with regard to ideas, teams, products or business practices.</p>
