...
#| echo: false
# Load distinct member experiences
me_dist2_prqt <- arrow::open_dataset("/Users/jschwarz/Downloads/member_experience_dist2.parquet") 
me_dist2_prqt |> 
  glimpse()
```
...
Current execution time on work station (32 cpus): 12h per batch (total 23d).
