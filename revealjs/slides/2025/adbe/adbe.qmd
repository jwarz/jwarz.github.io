...
![](assets/img/14_csc_01.svg){fig-align="center" style="padding-top: 1em;"}

::: {.fragment}

![](assets/img/15_whole_team.png){.absolute width=80% left=10% top=20% style="filter: drop-shadow(5px 5px 5px #222); -webkit-filter: drop-shadow(5px 5px 5px #222);"}
