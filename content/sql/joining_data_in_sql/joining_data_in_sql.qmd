...
3. Use `INTO` to save the result of the previous query as `pop_plus`. You can see an example of this\nin the `countries_plus` code in the assignment text. Make sure to include a `;` at the end of\nyour `WHERE` clause!
