...
comics <- read_csv("data/comics.csv", col_types = cols(.default = "f")) |> 
            ...
            # Relevel columns
            mutate(align  = align  |> fct_relevel("Bad", "Good", "Neutral")) |> 
            mutate(gender = gender |> fct_relevel("Female", "Male", "Other"))
...
comics_releveled <- comics_filtered |> 
  dplyr::mutate(align = align |> fct_relevel("Bad", "Neutral", "Good"))
...
email |> 
  mutate(spam = spam |> fct_recode(`not-spam` = "0", spam = "1")) |> 
  mutate(number_reordered = number |> fct_relevel("none", "small", "big")) |> 
