...
1. Type the following code in the editor: `my_apples \n
...
1. Experiment with the <a href="http://www.rdocumentation.org/packages/base/functions/order" target="_blank" rel="noopener noreferrer">`order()`</a> function in the console. Submit the answer when you are ready to continue.
